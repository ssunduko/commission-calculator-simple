...
/**
 * Base class for commission rules in the system.
 * This class represents the inheritance-based approach.
 */
public class CommissionRule {
    ...
    /**
     * Calculate commission amount for a given deal amount
     * @param dealAmount the deal amount to calculate commission for
     * @return the commission amount
     */
    public BigDecimal calculateCommission(BigDecimal dealAmount) {
        return dealAmount.multiply(rate.divide(new BigDecimal("100")));
    }
