...
/**
 * This class implements the DiscountStrategy interface for training products.
 ...
 */
public class TrainingDiscountStrategy implements DiscountStrategy {
    
    private static final BigDecimal DISCOUNT_RATE = new BigDecimal("0.20"); // 20% discount
